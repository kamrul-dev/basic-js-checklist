...
// 1. write 3 vriables (number, string, boolean)

// 2.  2 vairables using (let, const)

// 3.  Simple Math Operation ( +, -, *, /, %)

// 4. use of comparison operator

// 5. Two conditions. case-1: fulfill both conditions. case-2: fulill at least one conditon

// 6. if - else

// 7. while loop to display 7 to 19 all numbers. only display numbers including 7 to 19 numbers.
